...
insert into desease (id, name, description ) values (1003, "Stroke", "A stroke is a medical condition in which poor blood flow to the brain causes cell death. There are two main types of stroke: ischemic, due to lack of blood flow, and hemorrhagic, due to bleeding. Both cause parts of the brain to stop functioning properly. Signs and symptoms of a stroke may include an inability to move or feel on one side of the body, problems understanding or speaking, dizziness, or loss of vision to one side.");
insert into desease (id, name, description ) values (1004, "Diabetes", "Diabetes mellitus (DM), commonly known as diabetes, is a group of metabolic disorders characterized by a high blood sugar level over a prolonged period of time. Symptoms often include frequent urination, increased thirst, and increased appetite. If left untreated, diabetes can cause many complications. Acute complications can include diabetic ketoacidosis, hyperosmolar hyperglycemic state, or death. Serious long-term complications include cardiovascular disease, stroke, chronic kidney disease, foot ulcers, damage to the nerves, damage to the eyes and cognitive impairment.");
insert into desease (id, name, description ) values (1005, "High blood pressure", "High blood pressure is a common condition in which the long-term force of the blood against your artery walls is high enough that it may eventually cause health problems, such as heart disease. Blood pressure is determined both by the amount of blood your heart pumps and the amount of resistance to blood flow in your arteries. The more blood your heart pumps and the narrower your arteries, the higher your blood pressure.");
insert into desease (id, name, description ) values (1006, "Heart disease", "Coronary artery disease (CAD), also known as coronary heart disease (CHD) or ischemic heart disease (IHD), involves the reduction of blood flow to the heart muscle due to build-up of plaque in the arteries of the heart. It is the most common of the cardiovascular diseases. Types include stable angina, unstable angina, myocardial infarction, and sudden cardiac death. A common symptom is chest pain or discomfort which may travel into the shoulder, arm, back, neck, or jaw.");
insert into desease (id, name, description ) values (1007, "Cancer", "Cancer is a group of diseases involving abnormal cell growth with the potential to invade or spread to other parts of the body. These contrast with benign tumors, which do not spread. Possible signs and symptoms include a lump, abnormal bleeding, prolonged cough, unexplained weight loss, and a change in bowel movements. While these symptoms may indicate cancer, they can also have other causes. Over 100 types of cancers affect humans.");
insert into desease (id, name, description ) values (1008, "Heart attack", "A heart attack occurs when the flow of blood to the heart is blocked. The blockage is most often a buildup of fat, cholesterol and other substances, which form a plaque in the arteries that feed the heart (coronary arteries). Sometimes, a plaque can rupture and form a clot that blocks blood flow. The interrupted blood flow can damage or destroy part of the heart muscle.");
insert into desease (id, name, description ) values (1009, "Osteoporosis", "Osteoporosis causes bones to become weak and brittle — so brittle that a fall or even mild stresses such as bending over or coughing can cause a fracture. Osteoporosis-related fractures most commonly occur in the hip, wrist or spine. Bone is living tissue that is constantly being broken down and replaced. Osteoporosis occurs when the creation of new bone doesn't keep up with the loss of old bone.");

-- Depression
insert into desease_risks (desease_id, risks_id) values (1000, 1000);
insert into desease_risks (desease_id, risks_id) values (1000, 1001);
insert into desease_risks (desease_id, risks_id) values (1000, 1004);
...
insert into desease_risks (desease_id, risks_id) values (1001, 1000);
insert into desease_risks (desease_id, risks_id) values (1001, 1001);
insert into desease_risks (desease_id, risks_id) values (1001, 1003);

-- Weakened immune system
insert into desease_risks (desease_id, risks_id) values (1002, 1000);
insert into desease_risks (desease_id, risks_id) values (1002, 1002);
insert into desease_risks (desease_id, risks_id) values (1002, 1003);
insert into desease_risks (desease_id, risks_id) values (1002, 1004);
insert into desease_risks (desease_id, risks_id) values (1002, 1005);
insert into desease_risks (desease_id, risks_id) values (1002, 1006);
insert into desease_risks (desease_id, risks_id) values (1002, 1008);

-- Stroke
insert into desease_risks (desease_id, risks_id) values (1003, 1000);
...
insert into desease_risks (desease_id, risks_id) values (1003, 1007);

-- Diabetes 
insert into desease_risks (desease_id, risks_id) values (1004, 1000);
...
insert into desease_risks (desease_id, risks_id) values (1004, 1007);

-- High blood pressure
insert into desease_risks (desease_id, risks_id) values (1005, 1000);
insert into desease_risks (desease_id, risks_id) values (1005, 1003);
insert into desease_risks (desease_id, risks_id) values (1005, 1004);
insert into desease_risks (desease_id, risks_id) values (1005, 1006);
insert into desease_risks (desease_id, risks_id) values (1005, 1007);
insert into desease_risks (desease_id, risks_id) values (1005, 1008);

-- Heart disease
insert into desease_risks (desease_id, risks_id) values (1006, 1000);
insert into desease_risks (desease_id, risks_id) values (1006, 1001);
insert into desease_risks (desease_id, risks_id) values (1006, 1002);
insert into desease_risks (desease_id, risks_id) values (1006, 1004);
insert into desease_risks (desease_id, risks_id) values (1006, 1006);
insert into desease_risks (desease_id, risks_id) values (1006, 1007);


-- Cancer
insert into desease_risks (desease_id, risks_id) values (1007, 1002);
insert into desease_risks (desease_id, risks_id) values (1007, 1003);
...
-- Heart attack
insert into desease_risks (desease_id, risks_id) values (1008, 1000);
insert into desease_risks (desease_id, risks_id) values (1008, 1002);
insert into desease_risks (desease_id, risks_id) values (1008, 1005);
insert into desease_risks (desease_id, risks_id) values (1008, 1008);

-- Osteoporosis
insert into desease_risks (desease_id, risks_id) values (1009, 1003);
